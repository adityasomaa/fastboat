    ...
    <main className="min-h-screen bg-[var(--bg-soft)]" style={ACCENT}>
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="rounded-3xl bg-white p-8 text-center ring-1 ring-[var(--border)] sm:p-10">
          <div className="mx-auto grid h-16 w-16 place-items-center rounded-full bg-[#ff5946] text-white">
            <I.checkCircle size={36} aria-hidden />
          </div>
          <p className="font-script mt-5 text-3xl text-[#ff5946]">All set</p>
          ...
          <div className="mx-auto mt-6 inline-flex flex-col items-center rounded-2xl border border-dashed border-[#ff5946]/40 bg-[#ff5946]/5 px-6 py-4">
            <div className="inline-flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#ff5946]">
              <I.ticket size={ICON_SIZE.sm} aria-hidden />
              Booking code
            </div>
            <div className="font-mono text-2xl font-extrabold tabular-nums text-[#1f2440]">{code}</div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/design-4" className="tap-target inline-flex items-center gap-2 rounded-lg bg-white px-5 text-sm font-semibold ring-1 ring-[var(--border-strong)] hover:bg-[var(--bg-mute)]">
              Back to home
            </Link>
            <Link href="/design-4/admin" className="tap-target inline-flex items-center gap-2 rounded-lg bg-[#1f2440] px-5 text-sm font-semibold text-white hover:opacity-90">
