            ...
            <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
              ...
              <nav aria-label="Footer" className="text-sm">
                ...
                <ul className="mt-3 space-y-2 text-white/85">
                  <li><Link href="/fast-boat-tickets" className="hover:text-white hover:underline">Fast Boat Tickets</Link></li>
                  <li><Link href="/day-trips" className="hover:text-white hover:underline">Gili & Nusa Penida Day Trips</Link></li>
                  <li><Link href="/bali-tours" className="hover:text-white hover:underline">Bali Tours & Transfer</Link></li>
                  <li><Link href="/blog" className="hover:text-white hover:underline">Travel Blog</Link></li>
